  ...
  if not M._has_registered then
    vim.cmd([[
      augroup NightfoxdeprecationMessage
        au!
        autocmd VimEnter * ++once lua require("gentlefox.lib.deprecation").flush()
      augroup END
    ]])
...
function M.flush()
  M.write("See ", { "https://github.com/EdenEast/gentlefox.nvim ", "Title" }, "for more information.")
