...
function M.compile()
  require("gentlefox.lib.log").clear()

  local compiler = require("gentlefox.lib." .. (is_vim and "vim." or "") .. "compiler")
...
function M.setup(opts)
  ...
  local hash = require("gentlefox.lib.hash")(opts) .. (git == -1 and git_path or git)
