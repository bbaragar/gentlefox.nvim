...
<h1 align="center">Gentlefox</h1>

<p align="center">
  <a href="https://github.com/edeneast/gentlefox.nvim/stargazers"><img src="https://img.shields.io/github/stars/edeneast/gentlefox.nvim?colorA=192330&colorB=719cd6&style=for-the-badge"></a>
  <a href="https://github.com/edeneast/gentlefox.nvim/issues"><img src="https://img.shields.io/github/issues/edeneast/gentlefox.nvim?colorA=192330&colorB=dbc074&style=for-the-badge"></a>
  <a href="https://github.com/edeneast/gentlefox.nvim/contributors"><img src="https://img.shields.io/github/contributors/edeneast/gentlefox.nvim?colorA=192330&colorB=81b29a&style=for-the-badge"></a>
  <a href="https://github.com/EdenEast/gentlefox.nvim/network/members"><img src="https://img.shields.io/github/forks/edeneast/gentlefox.nvim?colorA=192330&colorB=9d79d6&style=for-the-badge"></a>
</p>
...
<div align="center">
  <h3>Gentlefox</h3><img src="https://user-images.githubusercontent.com/2746374/158456286-9e3ee657-60e6-49d8-b85e-dcab285b31c3.png" alt="gentlefox" style="border-radius:1%" />
...
```lua
use "EdenEast/gentlefox.nvim" -- Packer
```

```vim
Plug 'EdenEast/gentlefox.nvim' " Vim-Plug
```
...
require('gentlefox').setup({
  options = {
    ...
    compile_path = vim.fn.stdpath("cache") .. "/gentlefox",
...
To see a detailed explanation of gentlefox's config settings consult either the builtin help `:help gentlefox` or
[Usage](./usage.md).

### Modules

Gentlefox's modules store configuration information for various plugins and other neovim modules. To enable a module
...
You can change the color `palette` and the highlight `group` of gentlefox. Here is a brief example:

```lua
-- Palettes are the base color defines of a colorscheme.
-- You can override these palettes for each colorscheme defined by gentlefox.
local palettes = {
...
require("gentlefox").setup({ palettes = palettes, specs = specs, groups = groups })
...
`:help nvim-treesitter-highlights` for treesitter. If you would also like to see how gentlefox defines these highlight groups
...
To get more information check out [Usage](./usage.md#configuration) or the help file `:help gentlefox` for more detailed information.

[editor.lua]: https://github.com/EdenEast/gentlefox.nvim/blob/main/lua/gentlefox/group/editor.lua
[syntax.lua]: https://github.com/EdenEast/gentlefox.nvim/blob/main/lua/gentlefox/group/syntax.lua
[treesitter.lua]: https://github.com/EdenEast/gentlefox.nvim/blob/main/lua/gentlefox/group/modules/treesitter.lua

### Custom template values

Gentlefox's `palettes` and `specs` can be extended with your own values. This is useful for users that want to
...
Gentlefox exposes some Api's and utility classes that let you fetch data from gentlefox.
...
local palettes = require('gentlefox.palette').load()

-- Returns the palette of the specified colorscheme
local palette = require('gentlefox.palette').load("gentlefox")
...
local specs require('gentlefox.spec').load()

-- Returns the spec of the specified colorscheme
local spec = require('gentlefox.spec').load("gentlefox")
...
Gentlefox uses a color library internally to manipulate colors. You can use this library as well.
...
Gentlefox needs to simulate your cvd in order to shift colors correctly. This is done by setting your cvd type's severity
...
Another method would be to use the option `colorblind.simulate_only` option along with gentlefox's
[interactive](#interactive) mode. While gentlefox is simulating cvd set a severity to 1. Now decrease the severity
...
Gentlefox provides functions to work with the gentlefox compiler.

```vim
:GentlefoxCompile " Manually call gentlefox compiler to create/update compiled files
```

```lua
require('gentlefox').compile() -- lua api version
```
...
```lua
vim.cmd("colorscheme gentlefox")
vim.g.lightline = { colorscheme = "gentlefox" } -- Or the name of colorscheme you use
```
